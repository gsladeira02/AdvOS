  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Cadastre mensagens prontas para cobrança, contrato, assinatura e pedido de documentos. O AdvOS preenche os dados e abre o WhatsApp Web."
      />
      ...
      <section className="card mb-6 p-5">
        <h2 className="text-xl font-black">Variáveis disponíveis</h2>
      ...
      <section className="card mb-6 p-5">
        <h2 className="text-xl font-black">Novo modelo</h2>
        <form action="/api/message-templates" method="post" className="mt-4 grid gap-4">
          ...
          <textarea className="input min-h-[180px]" name="body" placeholder="Digite a mensagem usando variáveis como {{primeiro_nome}}, {{valor}}, {{vencimento}} e {{link_asaas}}" required />
        ...
        {(templates || []).map((template: any) => (
          <section className="card p-5" key={template.id}>
            <form action="/api/message-templates" method="post" className="grid gap-4">
              ...
              <textarea className="input min-h-[170px]" name="body" defaultValue={template.body || ''} />
